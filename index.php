                    ...
                    <form action='edit.php' method='POST'>
                        <div class='modal-body text-start'>
                           ...
                           <!--  <div class="col-12 mb-3">
                            ...
                            <div class="col-12 mb-3">
                                <label for="edit_idApartado" class="form-label">ID Apartado</label>
                                <input type="numeric" name="edit_idApartado" id="edit_idApartado" class="form-control" placeholder="" disabled>
                            </div>
                            <div class="col-12 mb-3">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="number" step=0.01 name="edit_liquidacion" id="edit_liquidacion" class=" form-control" placeholder="3.52" required>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('.editButton').on('click', function() {
               ...
               // $('#no').val(datos[1]);
                $('#edit_idSucursal').val(data[2]); //Asigna valor al campo idSucursal
                $('#edit_idCliente').val(data[3]);//Asigna valor al campo idCliente
                $('#edit_Anticipo').val(data[4]);//Asigna valor al campo Anticipo
                $('#edit_Cantidad').val(data[5]);//Asigna valor al campo Cantidad
                $('#edit_Detalles').val(data[6]);//Asigna valor al campo Detalles
                $('#edit_FechaAnticipo').val(data[7]);//Asigna valor al campo FechaAnticipo
                $('#edit_liquidacion').val(data[8]);//Asigna valor al campo liquidacion
            });
        });
    </script>
